...
echo '<div id="wpns_backup_message" style=" padding-top:8px ;padding-bottom : 8px;"></div>';	
echo'<div class="mo_wpns_divided_layout">
	<div class="mo_wpns_setting_layout">';

echo'	<h3>Manual Database Backup <a href='.esc_url($two_factor_premium_docfile['Manual Database Backup']).' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h3>
			<form id="mo_wpns_db_backup" method="post" action="">
				<input type="hidden" name="option" value="mo_wpns_db_backup" />
				<p>Backup your WordPress database easily with a single click. Your backup will be saved in <b>'.esc_url(site_url()).'/db-backups</b> .</p>
			...
			$("#mo_wpns_db_backup").on("submit",function (e){
			    ...
			    $.ajax({
			        ...
			        success: function(o) {
			        	...
			        	$("#dbloader").append("'.esc_attr($message2a).' "+result+" '.esc_attr($message2b).'");
	...
	echo   '</div>
	<div class="mo_wpns_setting_layout">
            <h3>Automatic Database Backup <a href='.esc_url($two_factor_premium_docfile['Automatic Database Backup']).' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h3>';?>
...
echo   '</div>
   		 <div class="mo_wpns_setting_layout">
           <h3>Files Backup <a href='.esc_url($two_factor_premium_docfile['Files Backup ']).' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a>  </h3>';?>
