	...
	echo'		<h3>Content Protection <a href='.esc_url($two_factor_premium_docfile['Content Protection']).' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h3>
				<form id="mo_wpns_content_protection" method="post" action="">
					...
					<p><input type="checkbox" name="prevent_directory_browsing" '.esc_html($protect_wp_uploads).'> <b>Prevent Directory Browsing</b> &nbsp;&nbsp; <span style="color:green;font-weight:bold;">(Recommended)</span> &nbsp;&nbsp; <a href="'.$wp_uploads.'" target="_blank" style="text-decoration:none">( Test it )</a></p>
					...
					<p><input type="checkbox" name="disable_file_editing" '.esc_html($disable_file_editing).'> <b>Disable File Editing from WP Dashboard (Themes and plugins)</b> &nbsp;&nbsp;<a href="'.$plugin_editor.'" target="_blank" style="text-decoration:none">( Test it )</a></p>
