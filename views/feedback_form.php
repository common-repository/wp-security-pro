    ...
    <div id="wpns_feedback_modal" class="mo_modal">
        ...
        <div class="mo_wpns_modal-content">
            ...
            <form name="f" method="post" action="" id="mo_mmp_feedback">
                ...
                <?php wp_nonce_field("mo_mmp_feedback");?>
                <input type="hidden" name="option" value="mo_mmp_feedback"/>
                <div class="mo_modal_content">
					...
					<div>
						...
						<div class="mo_feedback">
							<input type="radio" id="mo_fbk_4" name="mo_feedback" value="looking for specific feature" required>
					...
					<div>
						...
						<input type="checkbox" name="mo_anonymous_reply" value="reply">Do not reply</input>
					</div>
					<br>
					<div class="mo-modal-footer">
						<input type="submit" name="miniorange_feedback_submit" class="button button-primary button-large" value="Submit Feedback"/>
						&nbsp&nbsp
						<input type="button" name="miniorange_skip_feedback" class="button button-primary	 button-large" value="Skip & Deactivate" onclick="document.getElementById('mo_mmp_feedback_form_close').submit();"/>
					</div>
				</div>
			...
			<form name="f" method="post" action="" id="mo_mmp_feedback_form_close">
				<?php wp_nonce_field("mo_mmp_skip_feedback");?>
				<input type="hidden" name="option" value="mo_mmp_skip_feedback"/>
				<input type="hidden" id="query_mail" name="query_mail" required value="<?php echo esc_attr($email); ?>" readonly="readonly"/>
			</form>
        </div>
	</div>
