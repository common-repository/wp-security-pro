  ...
  <div class="mo_wpns_divided_layout">
  	<div class="mo_wpns_divided_layout_tab">
		<div class="mo_wpns_small_2_layout">
			<div class ="mo_wpns_sub_dashboards_layout">Attacks Blocked<hr class="line1"><p class="wpns_font_shown" ><?php echo esc_attr($totalAttacks); ?></p></div>
			<div class="mo_wpns_small_3_layout">
				<div class ="mo_wpns_sub_sub_dashboard_layout">Injections<hr class="line1"><?php echo esc_attr($sqlC); ?></div>
				<div class ="mo_wpns_sub_sub_dashboard_layout">RCE<hr class="line1"><?php echo esc_attr($rceC); ?></div>
				<div class ="mo_wpns_sub_sub_dashboard_layout">RFI/LFI<hr class="line1"><?php echo esc_attr($rfiC + $lfiC); ?></div>
				<div class ="mo_wpns_sub_sub_dashboard_layout">XSS<hr class="line1"><?php echo esc_attr($xssC); ?></div>
			</div>
		</div>
		<div class="mo_wpns_small_2_layout">
			
			<div class ="mo_wpns_sub_dashboards_layout">Blocked IPs<hr class="line1"><p class="wpns_font_shown"><?php echo esc_html($totalIPBlocked); ?></p></div>
			<div class="mo_wpns_small_3_layout">
				<div class ="mo_wpns_sub_sub_dashboard_layout">Manual<hr class="line1"><?php echo esc_attr($manualBlocks); ?></div>
				<div class ="mo_wpns_sub_sub_dashboard_layout">Real Time<hr class="line1"><?php echo esc_attr($realTime); ?></div>
				<div class ="mo_wpns_sub_sub_dashboard_layout">Country Blocked<hr class="line1"><?php echo esc_attr($countryBlocked); ?></div>
				<div class ="mo_wpns_sub_sub_dashboard_layout">IP Blocked by WAF<hr class="line1"><?php echo esc_attr($IPblockedByWAF); ?></div>
			</div>
		</div>
		</div>
...
<div id="block_list" class="tabcontent">
 ...
 <div class="mo_wpns_divided_layout">
		<div class="mo_wpns_setting_layout">
					<h2>Manual IP Blocking <a href='<?php echo esc_html($two_factor_premium_docfile['Manual IP Blocking']);?>' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h2>
...
echo 				esc_attr(date("M j, Y, g:i:s a",$blockedip->blocked_for_time));
echo 			"</td><td>".esc_attr(date("M j, Y, g:i:s a",intval($blockedip->created_timestamp)))."</td><td><a ".esc_attr($disabled)." onclick=unblockip('".esc_attr($blockedip->id)."')>Unblock IP</a></td></tr>";
			} 
?>
					</tbody>
					</table>
		...
		<div class="mo_wpns_setting_layout">
					<h2>IP Whitelisting <a href='<?php echo esc_html($two_factor_premium_docfile['IP Whitelisting']);?>' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h2>
...
<?php
					...
					{
						echo "<tr class='mo_wpns_not_bold'><td>".esc_attr($whitelisted_ip->ip_address)."</td><td>".esc_attr(date("M j, Y, g:i:s a",$whitelisted_ip->created_timestamp))."</td><td><a ".esc_attr($disabled)." onclick=removefromwhitelist('".$whitelisted_ip->id."')>Remove</a></td></tr>";
					} 
...
?>
		...
		<div class="mo_wpns_setting_layout">
					<h2>IP LookUp <a href='<?php echo esc_html($two_factor_premium_docfile['IP LookUp']);?>' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h2>
   ...
   <div class="mo_wpns_divided_layout">
     <div class="mo_wpns_setting_layout">
		<div id="RL" name="RL">
			...
			<tr>
			<th align="left">
			<h3>Rate Limiting:<a href='<?php echo esc_html($two_factor_premium_docfile['Rate Limiting']);?>' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a>
				<br>
...
<div class="mo_wpns_divided_layout">
	...
	<table style="width:100%">
		<tr><th align="left">
		<h3>Website firewall on plugin level:<a href='<?php echo esc_html($two_factor_premium_docfile['Plugin level waf']);?>' target="_blank"><span class="	dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a>
			<br>
		 ...
		 <tr><th align="left">
	<h3>Website firewall on .htaccess level <strong class="mo_wpns_feature_desc">[Recommended] </strong>:<a href='<?php echo esc_html($two_factor_premium_docfile['htaccess level waf']);?>' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a>
		<br>
		...
		<label class='mo_wpns_switch' >
		 <input type=checkbox  name='htaccessWAF' disabled /> 
		 <span class='mo_wpns_slider mo_wpns_round'></span>
		</label>
		 </h3></th></tr>
		 </table>
...
echo	 "<a href='". esc_attr($url)."' download='".esc_attr($nameDownload)."'>";?>
	...
	<tr>
		...
		<th align="left"><h2>	SQL Injection Protection<a href='<?php echo esc_html($two_factor_premium_docfile['SQL Injection Protection']);?>' target="_blank" class="mo_wpns_feature_desc"><strong style="color: #2271b1">[Basic Level Protection]</strong><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a>    
		...
		<th align="right">
			...
			<tr>
		<th align="left"><h2>	Local File Inclusion Protection <a href='<?php echo esc_html($two_factor_premium_docfile['Local File Inclusion Protection']);?>' target="_blank" class="mo_wpns_feature_desc"><strong style="color: #2271b1">[Basic Level Protection]</strong><span class="	dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a>   
				<br>
...
<script type="text/javascript">
			...
			var data = {
				...
				jQuery.post(ajaxurl, data, function(response) {
					...
					else if(response.geoplugin_status == 404)
					{
						jQuery("#resultsIPLookup").empty();
						jQuery('#wpns_message').empty();
						jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; IP details not found.</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
					}
		...
		jQuery('#saveRateL').click(function(){
			...
			if(req !='' && rateL !='' && Action !='')
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
					...
					{
						jQuery('#wpns_message').empty();
						jQuery('#wpns_message').append("<div class= 'notice notice-success is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp;Rate Limiting is disabled.</div>");
						window.scrollTo({ top: 0, behavior: 'smooth'});
						window.onload = nav_popup();
		...
		jQuery('#SQL').click(function(){
			...
			if(SQL != '')
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-success is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; SQL Injection protection is enabled</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
						else
		...
		jQuery('#XSS').click(function(){
			...
			if(XSS != '')
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-success is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; XSS detection is enabled</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
						else
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; XSS detection is disabled.</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
		...
		jQuery('#LFI').click(function(){
			...
			if(LFI != '')
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-success is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; LFI detection is enabled</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
						else
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; LFI detection is disabled.</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
				});				
		...
		jQuery('#pluginWAF').click(function(){
			...
			if(pluginWAF != '')
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; File permission denied for wp-content/uploads folder. </div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
						else
		...
		jQuery('#htaccessWAF').click(function(){
			...
			if(htaccessWAF != 'on')
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						if(response == 'HWAFdisabled')
						{
							...
							jQuery('#LFI').prop("checked",false);
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; WAF is disabled</div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
						else
			...
			else
			{
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						{
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; An error has occured while activating WAF.</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}
						else
		...
		jQuery('#cnclDH').click(function(){
			...
			jQuery('#wpns_message').empty();
			jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; WAF activation canceled</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
		...
		jQuery('#CDhtaccess').click(function(){
			...
			var nonce = '<?php echo wp_create_nonce("WAFsettingNonce");?>';
				...
				jQuery.post(ajaxurl, data, function(response) {
						...
						{	
							jQuery('#wpns_message').empty();
							jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; An error has occured.There might be another WAF exists.</div></div>");
							window.scrollTo({ top: 0, behavior: 'smooth'});
							window.onload = nav_popup();
						}				
				});
	...
	if(id != '')
	{
		...
		jQuery.post(ajaxurl, data, function(response) {
				...
				else
				{
					jQuery('#wpns_message').empty();
					refreshWhiteListTable(response);	
					jQuery('#wpns_message').append("<div class= 'notice notice-error is-dismissible' style='height : 25px;padding-top: 10px;  ' >&nbsp; &nbsp; IP removed from Whitelist.</div>");
					window.scrollTo({ top: 0, behavior: 'smooth'});
					window.onload = nav_popup();		
				}
		});
