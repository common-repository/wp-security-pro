...
echo ' 		<h3>Brute Force Protection ( Login Protection )<a href='.esc_url($two_factor_premium_docfile['Brute Force Protection']).' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h3>
...
echo'	
		...
		<div class="mo_wpns_setting_layout">		
			<h3>Google reCAPTCHA <a href='.esc_url($two_factor_premium_docfile['Google reCAPTCHA']).' target="_blank"><span class="dashicons dashicons-external mo_wpns_doc_link" title="More information.."></span></a></h3>
