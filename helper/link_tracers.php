<?php 
 $two_factor_premium_docfile = array(
            ...
            "Session Control" =>"https://plugins.miniorange.com/set-two-factor-from-session-addon",
            ...
            "Plugin level waf" => "https://security.miniorange.com/how-to-configure-firewall-plugin-on-wordpress/#stepc",

            "htaccess level waf"=>"https://security.miniorange.com/how-to-configure-firewall-plugin-on-wordpress/#stepc",

            "SQL Injection Protection"=>"https://security.miniorange.com/how-to-configure-firewall-plugin-on-wordpress/#stepe",

            "Cross Site scripting Protection"=>"https://security.miniorange.com/how-to-configure-firewall-plugin-on-wordpress/#stepd",

            "Local File Inclusion Protection"=>"https://security.miniorange.com/how-to-configure-firewall-plugin-on-wordpress/#stepf",
            ...
            "Enforce Strong Passwords"=>"https://developers.miniorange.com/docs/security/wordpress/wp-security/brute-force#Enforce-strong-password",
             ...
             "Content Protection"=>"https://plugins.miniorange.com/content-spam-protection-with-malware-protection-plugin#stepb",
            ...
            "Files Backup "=>"https://developers.miniorange.com/docs/security/wordpress/wp-security/backup-restore/#Take-wordpress-backup",
          "Manual Database Backup"  =>"https://developers.miniorange.com/docs/security/wordpress/wp-security/backup-restore/#Take-wordpress-backup",
           "Automatic Database Backup"  =>"https://developers.miniorange.com/docs/security/wordpress/wp-security/backup-restore/#Take-wordpress-backup",
