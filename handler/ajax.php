...
class Mo_wpAjaxHandler
{
	...
	private function lookupIP($ip)
	{
		...
		$ipLookUpTemplate  = Mo_wp_Constants::IP_LOOKUP_TEMPLATE;
	...
	{
		global $Mo_wpUtility;
		$moPluginsUtility = new Mo_wpHandler();
		$moPluginsUtility->whitelist_ip($Mo_wpUtility->get_client_ip());
		wp_send_json('success');
	}
