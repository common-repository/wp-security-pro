...
class Mo_wp_ajax_dashboard
{
	...
	public function mo2f_handle_all_enable($POSTED){
		...
		if($POSTED){
			...
			do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('ALL_ENABLED'),'SUCCESS');
		}
		else{
			update_site_option('mo_mmp_switch_all', 0);
			update_site_option('mo_mmp_tab_count', 0);
			do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('ALL_DISABLED'),'ERROR');
		}
	}
	...
	public function mo2f_handle_waf_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_waf_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('WAF_ENABLE'),'SUCCESS');
		}
		else{
			...
			if($_POST['option'] == 'tab_waf_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('WAF_DISABLE'),'ERROR');
		}
	}
	...
	public function mo2f_handle_login_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_login_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('LOGIN_ENABLE'),'SUCCESS');
		}
		else{
			...
			if($_POST['option'] == 'tab_login_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('LOGIN_DISABLE'),'ERROR');
		}
	}
	...
	public function mo2f_handle_backup_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_backup_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('BACKUP_ENABLE'),'SUCCESS');
		}
		else{
			update_site_option('mo_mmp_switch_backup', 0);
			update_site_option('mo_mmp_tab_count', get_site_option('mo_mmp_tab_count')-1);
			$handler_obj = new Mo_wp_site_backup;
        	...
        	if($_POST['option'] == 'tab_backup_switch')
        		do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('BACKUP_DISABLE'),'ERROR');
		}
	}
	...
	public function mo2f_handle_malware_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_malware_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('MALWARE_ENABLE'),'SUCCESS');
		}else{
			update_site_option('mo_mmp_switch_malware', 0);
			update_site_option('mo_mmp_tab_count', get_site_option('mo_mmp_tab_count')-1);
			if($_POST['option'] == 'tab_malware_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('MALWARE_DISABLE'),'ERROR');
		}
	}
	...
	public function mo2f_handle_block_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_block_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('ADV_BLOCK_ENABLE'),'SUCCESS');
		}
		else{
			...
			if($_POST['option'] == 'tab_block_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('ADV_BLOCK_DISABLE'),'ERROR');
		}
	}
	...
	public function mo2f_handle_report_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_report_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('REPORT_ENABLE'),'SUCCESS');
		}
		else{
			update_site_option('mo_mmp_switch_reports', 0);
			update_site_option('mo_mmp_tab_count', get_site_option('mo_mmp_tab_count')-1);
			if($_POST['option'] == 'tab_report_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('REPORT_DISABLE'),'ERROR');
		}
	}
	...
	public function mo2f_handle_notif_enable($POSTED){
		if($POSTED){
			...
			if($_POST['option'] == 'tab_notif_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('NOTIF_ENABLE'),'SUCCESS');
		}
		else{
			...
			if($_POST['option'] == 'tab_notif_switch')
				do_action('mo_mmp_show_message',Mo_wp_Messages::showMessage('NOTIF_DISABLE'),'ERROR');
		}
	}

}
new Mo_wp_ajax_dashboard();
?>